...
def ToDevice(x):
    return x.to(mydevice) if torch.cuda.is_available() else x
...
if __name__ == '__main__':
    ...
    python Utility.py
    '''
    root = '/mnt/nfs7/y50021900/My/SIGGRAPH_2022'
    data_file = root + "/Dataset/Data.bin"
    ReadBatch(binaryFile=data_file, sampleIndices = [1, 2, 3], featureCount=[1])
